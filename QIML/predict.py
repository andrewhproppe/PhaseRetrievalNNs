...
from QIML.models.base import models
from QIML.pipeline.transforms import Normalize
from QIML.utils import paths
from QIML.visualization.AP_figs_funcs import find_nearest
...
def get_model(model_name: str = "CLpcfs", cuda: bool = False, train: bool = False):
    ...
    model_name : str, optional
        ...
        defined in `QIML.models.base.models` as a dictionary.
    cuda : bool, optional
